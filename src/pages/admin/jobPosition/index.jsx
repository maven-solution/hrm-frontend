import { getjobPositions } from "@/api/admin/jobs";
...

          {
            ...
            Cell: ({ cell }) => (
              <div className="flex items-center gap-4">
                <Link
                  href={adminroutes.jobPosition.update + cell.row.original._id}
  ...
  return (
    <>
      <div className="fixed bottom-10 right-10">
        <LinkButton
          link={adminroutes.jobPosition.create}
          title="create"
          icon={<AiOutlinePlus />}
        />
      </div>
